...
public class SwerveFSM {
    ...
    private static final double FRONT_LEFT_ABSOLUTE_ENCODER_OFFSET = 0; //PLACEHOLDER VALUE
    private static final double FRONT_RIGHT_ABSOLUTE_ENCODER_OFFSET = 0; //PLACEHOLDER VALUE
    private static final double BACK_LEFT_ABSOLUTE_ENCODER_OFFSET = 0; //PLACEHOLDER VALUE
    private static final double BACK_RIGHT_ABSOLUTE_ENCODER_OFFSET = 0; //PLACEHOLDER VALUE
	...
	public SwerveFSM() {
		...
		frontLeft = new SwerveModule(HardwareMap.CAN_ID_FRONT_LEFT_DRIVE, HardwareMap.CAN_ID_FRONT_LEFT_TURN,
            ...
            FRONT_LEFT_ABSOLUTE_ENCODER_REVERSED, FRONT_LEFT_ABSOLUTE_ENCODER_OFFSET);
        frontRight = new SwerveModule(HardwareMap.CAN_ID_FRONT_RIGHT_DRIVE, HardwareMap.CAN_ID_FRONT_RIGHT_TURN,
            ...
            FRONT_RIGHT_ABSOLUTE_ENCODER_REVERSED, FRONT_RIGHT_ABSOLUTE_ENCODER_OFFSET);
        backLeft = new SwerveModule(HardwareMap.CAN_ID_BACK_LEFT_DRIVE, HardwareMap.CAN_ID_BACK_LEFT_TURN,
            ...
            BACK_LEFT_ABSOLUTE_ENCODER_REVERSED, BACK_LEFT_ABSOLUTE_ENCODER_OFFSET);
        backRight = new SwerveModule(HardwareMap.CAN_ID_BACK_RIGHT_DRIVE, HardwareMap.CAN_ID_BACK_RIGHT_TURN,
            ...
            BACK_RIGHT_ABSOLUTE_ENCODER_REVERSED, BACK_RIGHT_ABSOLUTE_ENCODER_OFFSET);
	...
	private void handleDriveState(TeleopInput input) {
        ...
        double yAxis = input.getSwerveJoystickLeftY();
